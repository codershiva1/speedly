...
body { margin: 0; font-family: Arial, sans-serif; }
            ...
            /* Orange layer using scale instead of sliding */
            #searchBtn::before {
                content: "";
                position: absolute;
                top: 0;
                ...
                height: 100%;
                background: #f04706;
                transform-origin: left;     /* IMPORTANT: animation direction */
                transform: scaleX(0);       /* Hidden but ready at left */
                transition: transform 0.35s ease;
                z-index: -1;
            }
           
            /* Hover: orange expands left → right */
    ...
    background: #f3f3f3;
        ...
        .speaker-text {
            ...
            <div style="display:flex; align-items:center;">
                <div class="logo">sPeedly <span style="font-size:12px;">Best Buy</span></div>
