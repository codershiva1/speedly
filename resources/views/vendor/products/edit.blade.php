                    ...
                    <form method="POST" action="{{ route('vendor.products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="discount_price" name="discount_price" type="number" step="0.01" class="mt-1 block w-full" :value="old('discount_price', $product->discount_price)" />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="short_description" name="short_description" rows="2" class="mt-1 block w-full border-gray-300 rounded-md">{{ old('short_description', $product->short_description) }}</textarea>
                        ...
                        <div class="flex justify-end mt-6">
                            <a href="{{ route('vendor.products.index') }}" class="me-3 text-sm text-gray-600 hover:underline">{{ __('Cancel') }}</a>
