                    ...
                    <form method="POST" action="{{ route('admin.brands.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex items-center gap-6">
                                <div id="image-preview" class="h-20 w-20 rounded-xl bg-gray-50 border-2 border-dashed border-gray-200 flex items-center justify-center text-gray-400 overflow-hidden">
                                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" stroke-width="2"></path></svg>
                                </div>
                                <div class="flex-1">
                        ...
                        <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                            <label for="status" class="inline-flex items-center cursor-pointer">
                                <input id="status" type="checkbox" name="status" value="1" 
                                    class="rounded-md border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" checked>
                                <span class="ms-3 text-sm font-semibold text-gray-700">{{ __('Activate this brand') }}</span>
                            </label>
                            <p class="ms-8 text-xs text-gray-400">If inactive, this brand and its products won't show in the store.</p>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                            ...
                            <x-primary-button class="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-xl shadow-lg shadow-indigo-100 transition-all">
                                {{ __('Create Brand') }}
                            </x-primary-button>
                        </div>
                    </form>
