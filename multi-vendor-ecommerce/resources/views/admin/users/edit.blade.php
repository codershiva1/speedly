...
<div class="p-8 bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 mt-1">Update karein <span class="text-emerald-600 font-semibold">{{ $user->name }}</span> ki details aur permissions.</p>
        </div>
                ...
                <div class="lg:col-span-4">
                    <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 text-center sticky top-8">
                        ...
                        <div class="relative group inline-block">
                            <div class="w-40 h-40 rounded-3xl overflow-hidden ring-4 ring-emerald-50 bg-gray-100 border-2 border-white shadow-md">
                                @if($user->image_url)
                        ...
                        <div class="mt-4">
                            ...
                            <span class="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-[10px] font-bold uppercase tracking-wider">{{ $user->role }}</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" value="{{ old('name', $user->name) }}" required 
                                    class="w-full bg-gray-50 border-none rounded-2xl px-5 py-3.5 focus:bg-white focus:ring-2 focus:ring-emerald-500 transition outline-none text-gray-800 shadow-inner" 
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    <select name="role" required class="w-full bg-gray-50 border-none rounded-2xl px-5 py-3.5 focus:bg-white focus:ring-2 focus:ring-emerald-500 appearance-none outline-none text-gray-800 shadow-inner">
