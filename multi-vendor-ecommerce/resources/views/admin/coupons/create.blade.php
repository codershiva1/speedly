                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white  shadow-sm border border-gray-100 rounded-3xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="col-span-2">
                                    ...
                                    <x-text-input id="code" name="code" type="text" class="block w-full mt-1 rounded-xl border-gray-200 focus:ring-emerald-500" :value="old('code')" placeholder="SUMMER50" required />
                                    <x-input-error :messages="$errors->get('code')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="type" :value="__('Discount Type')" class="text-xs font-bold uppercase text-gray-500 mb-2" />
                                    <select name="type" id="type" class="block w-full mt-1 rounded-xl border-gray-200 focus:ring-emerald-500 text-sm">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="value" name="value" type="number" step="0.01" class="block w-full mt-1 rounded-xl border-gray-200 focus:ring-emerald-500" :value="old('value')" placeholder="0.00" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white  shadow-sm border border-gray-100 rounded-3xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="min_cart_value" name="min_cart_value" type="number" step="0.01" class="block w-full mt-1 rounded-xl border-gray-200 focus:ring-emerald-500" :value="old('min_cart_value', 0)" required />
                                </div>
                                <div>
                                    <x-input-label for="max_uses" :value="__('Usage Limit (Total)')" class="text-xs font-bold uppercase text-gray-500 mb-2" />
                                    <x-text-input id="max_uses" name="max_uses" type="number" class="block w-full mt-1 rounded-xl border-gray-200 focus:ring-emerald-500" :value="old('max_uses')" placeholder="e.g. 100" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white p-6 shadow-sm border border-gray-100 rounded-3xl">
                            ...
                            <div class="mt-6">
                                <button type="submit" class="w-full bg-emerald-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-emerald-100 hover:bg-emerald-700 transition duration-150 uppercase text-xs tracking-widest">
                                    Create Coupon
                                </button>
                            </div>
                        </div>
