...
<section 
    class="flex items-center gap-4 overflow-x-auto bg-white shadow-sm rounded-lg px-4 py-2 category-bar justify-content-between"
    data-aos="fade-up" 
>
    <!-- All -->
    ...
    <a href="{{ route('shop.index') }}" class="flex flex-col items-center gap-1 group min-w-[70px]">
        <div class=" flex items-center justify-center text-1xl transition-transform group-hover:scale-110">
            🛍️
        </div>
